...
@model({
  settings: {idInjection: false, postgresql: {schema: 'folk_tune', table: 'measures'}}
})
export class Measures extends Entity {
  @property({
    type: 'number',
    required: true,
    scale: 0,
  ...
  constructor(data?: Partial<Measures>) {
    super(data);
  }
}

export interface MeasuresRelations {
  // describe navigational properties here
}

export type MeasuresWithRelations = Measures & MeasuresRelations;
