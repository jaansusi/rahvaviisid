...
export class TextForms extends Entity {
  @property({
    type: 'number',
    required: true,
    scale: 0,
  ...
  constructor(data?: Partial<TextForms>) {
    super(data);
  }
}

export interface TextFormsRelations {
  // describe navigational properties here
}

export type TextFormsWithRelations = TextForms & TextFormsRelations;
