...
@model({
  settings: {idInjection: false, postgresql: {schema: 'folk_tune', table: 'key_signatures'}}
})
export class KeySignatures extends Entity {
  @property({
    type: 'number',
    required: false,
    scale: 0,
  ...
  constructor(data?: Partial<KeySignatures>) {
    super(data);
  }
}

export interface KeySignaturesRelations {
  // describe navigational properties here
}

export type KeySignaturesWithRelations = KeySignatures & KeySignaturesRelations;
