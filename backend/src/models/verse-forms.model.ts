...
export class VerseForms extends Entity {
  @property({
    type: 'number',
    required: false,
    scale: 0,
  ...
  constructor(data?: Partial<VerseForms>) {
    super(data);
  }
}

export interface VerseFormsRelations {
  // describe navigational properties here
}

export type VerseFormsWithRelations = VerseForms & VerseFormsRelations;
