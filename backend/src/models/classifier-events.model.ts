...
@model({
  settings: {
    idInjection: false,
    postgresql: {schema: 'folk_tune', table: 'classifier_events'}
  }
})
export class ClassifierEvents extends Entity {
  @property({
    type: 'number',
    required: false,
    scale: 0,
  ...
  constructor(data?: Partial<ClassifierEvents>) {
    super(data);
  }
}

export interface ClassifierEventsRelations {
  // describe navigational properties here
}

export type ClassifierEventsWithRelations = ClassifierEvents & ClassifierEventsRelations;
