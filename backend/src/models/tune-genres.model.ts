...
@model({
  settings: {idInjection: false, postgresql: {schema: 'folk_tune', table: 'tune_genres'}}
})
export class TuneGenres extends Entity {
  @property({
    type: 'number',
    required: false,
    scale: 0,
  ...
  constructor(data?: Partial<TuneGenres>) {
    super(data);
  }
}

export interface TuneGenresRelations {
  // describe navigational properties here
}

export type TuneGenresWithRelations = TuneGenres & TuneGenresRelations;
