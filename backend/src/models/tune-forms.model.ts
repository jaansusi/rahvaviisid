...
@model({
  settings: {idInjection: false, postgresql: {schema: 'folk_tune', table: 'tune_forms'}}
})
export class TuneForms extends Entity {
  @property({
    type: 'number',
    required: false,
    scale: 0,
  ...
  constructor(data?: Partial<TuneForms>) {
    super(data);
  }
}

export interface TuneFormsRelations {
  // describe navigational properties here
}

export type TuneFormsWithRelations = TuneForms & TuneFormsRelations;
