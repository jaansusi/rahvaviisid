...
@model({
  settings: {
    idInjection: false,
    postgresql: {schema: 'folk_tune', table: 'user_role_types'}
  }
})
export class UserRoleTypes extends Entity {
  @property({
    type: 'number',
    required: false,
    scale: 0,
  ...
  constructor(data?: Partial<UserRoleTypes>) {
    super(data);
  }
}

export interface UserRoleTypesRelations {
  // describe navigational properties here
}

export type UserRoleTypesWithRelations = UserRoleTypes & UserRoleTypesRelations;
