...
@model({
  settings: {idInjection: false, postgresql: {schema: 'folk_tune', table: 'municipalities'}}
})
export class Municipalities extends Entity {
  @property({
    type: 'number',
    required: false,
    scale: 0,
  ...
  constructor(data?: Partial<Municipalities>) {
    super(data);
  }
}

export interface MunicipalitiesRelations {
  // describe navigational properties here
}

export type MunicipalitiesWithRelations = Municipalities & MunicipalitiesRelations;
