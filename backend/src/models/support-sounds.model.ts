...
@model({
  settings: {idInjection: false, postgresql: {schema: 'folk_tune', table: 'support_sounds'}}
})
export class SupportSounds extends Entity {
  @property({
    type: 'number',
    required: false,
    scale: 0,
  ...
  constructor(data?: Partial<SupportSounds>) {
    super(data);
  }
}

export interface SupportSoundsRelations {
  // describe navigational properties here
}

export type SupportSoundsWithRelations = SupportSounds & SupportSoundsRelations;
