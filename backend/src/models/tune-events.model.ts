...
@model({
  settings: {idInjection: false, postgresql: {schema: 'folk_tune', table: 'tune_events'}}
})
export class TuneEvents extends Entity {
  @property({
    type: 'number',
    required: false,
    scale: 0,
  ...
  constructor(data?: Partial<TuneEvents>) {
    super(data);
  }
}

export interface TuneEventsRelations {
  // describe navigational properties here
}

export type TuneEventsWithRelations = TuneEvents & TuneEventsRelations;
