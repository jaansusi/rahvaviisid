...
@model({
  settings: {idInjection: false, postgresql: {schema: 'folk_tune', table: 'sexes'}}
})
export class Sexes extends Entity {
  @property({
    type: 'number',
    required: false,
    scale: 0,
  ...
  constructor(data?: Partial<Sexes>) {
    super(data);
  }
}

export interface SexesRelations {
  // describe navigational properties here
}

export type SexesWithRelations = Sexes & SexesRelations;
