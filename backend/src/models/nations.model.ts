...
@model({
  settings: {idInjection: false, postgresql: {schema: 'folk_tune', table: 'nations'}}
})
export class Nations extends Entity {
  @property({
    type: 'number',
    required: false,
    scale: 0,
  ...
  constructor(data?: Partial<Nations>) {
    super(data);
  }
}

export interface NationsRelations {
  // describe navigational properties here
}

export type NationsWithRelations = Nations & NationsRelations;
