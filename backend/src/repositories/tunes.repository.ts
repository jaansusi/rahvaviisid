...
export class TunesRepository extends DefaultCrudRepository<
  ...
  TunesRelations
> {
  public readonly tuneTranscriptions: HasManyRepositoryFactory<
    TuneTranscriptions,
    typeof Tunes.prototype.id
  >;
  public readonly countries: HasOneRepositoryFactory<
    Countries,
    typeof Tunes.prototype.id
  >;
  public readonly nations: HasOneRepositoryFactory<
    Nations,
    typeof Tunes.prototype.id
  >;
  ...
  public readonly tunePerformances: HasManyRepositoryFactory<
    ...
    typeof Tunes.prototype.id
  >;
  public readonly tunePlaces: HasManyRepositoryFactory<
    TunePlaces,
    typeof Tunes.prototype.id
  >;
  public readonly tunesPersonsRoles: HasManyRepositoryFactory<
    TunesPersonsRoles,
    typeof Tunes.prototype.id
  >;
  public readonly tuneSongs: HasManyRepositoryFactory<
    TuneSongs,
    typeof Tunes.prototype.id
  >;
  public readonly tuneEncodings: HasManyRepositoryFactory<
    TuneEncodings,
    typeof Tunes.prototype.id
  >;
  public readonly externalReferences: HasManyRepositoryFactory<
    ExternalReferences,
    typeof Tunes.prototype.id
  >;

  public readonly musicalCharacteristics: HasManyRepositoryFactory<
    MusicalCharacteristics,
    typeof Tunes.prototype.id
  >;
  ...
  constructor(
    ...
    @repository.getter('TuneTranscriptionsRepository')
    protected tuneTranscriptionsRepositoryGetter: Getter<TuneTranscriptionsRepository>,
    @repository.getter('CountriesRepository')
    protected countriesRepositoryGetter: Getter<CountriesRepository>,
    @repository.getter('NationsRepository')
    ...
    protected tunePlacesRepositoryGetter: Getter<TunePlacesRepository>,
    ...
    @repository.getter('TuneSongsRepository')
    protected tuneSongsRepositoryGetter: Getter<TuneSongsRepository>,
    @repository.getter('TuneEncodingsRepository')
    protected tuneEncodingsRepositoryGetter: Getter<TuneEncodingsRepository>,
    ...
    this.registerInclusionResolver(
      'musicalCharacteristics',
      this.musicalCharacteristics.inclusionResolver,
    );
    this.tuneEncodings = this.createHasManyRepositoryFactoryFor(
      'tuneEncodings',
      tuneEncodingsRepositoryGetter,
    );
    this.registerInclusionResolver(
      'tuneEncodings',
      this.tuneEncodings.inclusionResolver,
    );
    this.tuneSongs = this.createHasManyRepositoryFactoryFor(
      'tuneSongs',
      tuneSongsRepositoryGetter,
    );
    this.registerInclusionResolver(
      'tuneSongs',
      this.tuneSongs.inclusionResolver,
    );
    this.tunesPersonsRoles = this.createHasManyRepositoryFactoryFor(
      'tunesPersonsRoles',
      tunesPersonsRolesRepositoryGetter,
    );
    this.registerInclusionResolver(
      'tunesPersonsRoles',
      this.tunesPersonsRoles.inclusionResolver,
    );
    this.tunePlaces = this.createHasManyRepositoryFactoryFor(
      'tunePlaces',
      tunePlacesRepositoryGetter,
    );
    this.registerInclusionResolver(
      'tunePlaces',
      this.tunePlaces.inclusionResolver,
    );
    this.tunePerformances = this.createHasManyRepositoryFactoryFor(
      'tunePerformances',
    ...
    this.languages = this.createHasOneRepositoryFactoryFor(
      'languages',
      languagesRepositoryGetter,
    );
    this.registerInclusionResolver(
      'languages',
    ...
    this.nations = this.createHasOneRepositoryFactoryFor(
      'nations',
      nationsRepositoryGetter,
    );
    this.registerInclusionResolver('nations', this.nations.inclusionResolver);
    this.countries = this.createHasOneRepositoryFactoryFor(
      'countries',
      countriesRepositoryGetter,
    );
    this.registerInclusionResolver(
      'countries',
      this.countries.inclusionResolver,
    );
    this.tuneTranscriptions = this.createHasManyRepositoryFactoryFor(
      'tuneTranscriptions',
      tuneTranscriptionsRepositoryGetter,
    );
    this.registerInclusionResolver(
      'tuneTranscriptions',
      this.tuneTranscriptions.inclusionResolver,
    );
    this.externalReferences = this.createHasManyRepositoryFactoryFor(
      'externalReferences',
      externalReferencesRepositoryGetter,
    );
    this.registerInclusionResolver(
      'externalReferences',
      this.externalReferences.inclusionResolver,
    );
  }
}
